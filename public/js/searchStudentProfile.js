...
// Attach the searchStudentProfile function to the search button click event
...
// function landingSearchStudentProfile() {
//     const idNumberInput = document.getElementById('searchIDNumber');
//     if (!idNumberInput) {
//         console.log('Element with ID "searchIDNumber" not found');
//         return;
//     }
...
//     // Send a request to the server to search for the student profile
//     fetch(`/university-events-admin/search?searchIDNumber=${idNumber}`)
//         .then(response => response.json())
//         .then(data => {
//             // Update the page with the search results
//             if (data.studentFound) {
...
// }
// // Attach the searchStudentProfile function to the search button click event
// document.getElementById('landingSearchRecord').addEventListener('click', landingSearchStudentProfile);